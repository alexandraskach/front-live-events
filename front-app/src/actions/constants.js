...
export const CONCERT_LIST_REQUEST = "CONCERT_LIST_REQUEST";
export const CONCERT_LIST_RECEIVED = "CONCERT_LIST_RECEIVED";
export const CONCERT_LIST_ERROR = "CONCERT_LIST_ERROR";
export const CONCERT_LIST_ADD = "CONCERT_LIST_ADD";
export const CONCERT_LIST_SET_PAGE = "CONCERT_LIST_SET_PAGE";

export const CONCERT_LIST_STYLE_REQUEST = "CONCERT_LIST_STYLE_REQUEST";
export const CONCERT_LIST_STYLE_RECEIVED = "CONCERT_LIST_STYLE_RECEIVED";
export const CONCERT_LIST_STYLE_ERROR = "CONCERT_LIST_STYLE_ERROR";

export const CONCERT_REQUEST = "CONCERT_REQUEST";
export const CONCERT_RECEIVED = "CONCERT_RECEIVED";
export const CONCERT_ERROR = "CONCERT_ERROR";
export const CONCERT_UNLOAD = "CONCERT_UNLOAD";
export const CONCERT_FORM_UNLOAD = "CONCERT_FORM_UNLOAD";
